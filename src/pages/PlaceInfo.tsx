                                        ...
                                        <div className="m-5 w-4/5">
                                            ...
                                            {res && res.division === '음식점' && (
                                                <table>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>{res ? (res.restaurant.dayOff === 'nan' ? '-' : res.restaurant.dayOff) : '-'}</td>
                                                            <td>{res ? res.restaurant.mainMenu : '-'}</td>
                                                            <td>{res ? res.restaurant.menu : '-'}</td>
                                                            <td>{res ? (res.restaurant.packaging === 'nan' ? '-' : res.restaurant.packaging) : '-'}</td>
                                                            <td>{res ? (res.restaurant.parking || '-') : '-'}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            )}
